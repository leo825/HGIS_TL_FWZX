...
(function ($) {
    ...
    function _14(_15) {
        ...
        _17.find("a.slider-handle").draggable({
            axis: _16.mode, cursor: "pointer", disabled: _16.disabled, onDrag: function (e) {
                var _18 = e.data.left;
                var _19 = _17.width();
                if (_16.mode != "h") {
                    _18 = e.data.top;
    ...
    $.fn.slider = function (_31, _32) {
        ...
        return this.each(function () {
            ...
            if (_33) {
                ...
                _33 = $.data(this, "slider", {
                    options: $.extend({}, $.fn.slider.defaults, $.fn.slider.parseOptions(this), _31),
                    slider: _1(this)
                });
    ...
    $.fn.slider.parseOptions = function (_36) {
        var t = $(_36);
        return $.extend({}, $.parser.parseOptions(_36, ["width", "height", "mode", {
            reversed: "boolean",
            showTip: "boolean",
            min: "number",
            max: "number",

...
(function ($) {
    ...
    function _12(_13, _14, el) {
        ...
        if (pp.panel("options").split) {
            ...
            _19.resizable({
                handles: _1a, onStartResize: function (e) {
                    _1 = true;
    ...
    function _26(_27, _28, _29) {
        ...
        function _2e() {
            ...
            if (_28 == "east") {
                return {
                    resizeC: {width: _2a.center.panel("options").width + _2a["east"].panel("options").width - 28},
                    expand: {left: cc.width() - _2a["east"].panel("options").width},
                    expandP: {
                ...
                if (_28 == "west") {
                    return {
                        ...
                        collapse: {left: -_2a["west"].panel("options").width}
                    };
                } else {
                    if (_28 == "north") {
                        var hh = cc.height() - 28;
                        ...
                        return {
                            ...
                            collapse: {top: -_2a["north"].panel("options").height}
                        };
                    } else {
                        if (_28 == "south") {
                            var hh = cc.height() - 28;
                            ...
                            return {
                                resizeC: {height: hh},
                                expand: {top: cc.height() - _2a["south"].panel("options").height},
                ...
                if (_33 == "west" && _34.expandWest) {
                    ...
                    if (_33 == "north" && _34.expandNorth) {
                        ...
                        if (_33 == "south" && _34.expandSouth) {
                            return {
                                collapse: {top: cc.height()},
                                expand: {top: cc.height() - _34["south"].panel("options").height}
                            };
                        }
                    }
                }

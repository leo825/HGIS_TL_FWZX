...
public class RoleController {
    ...
    @ResponseBody
    public JsonResponse save(@RequestBody RoleModel mode) {
        try {
    ...
    @ResponseBody
    public JsonResponse update(@RequestBody RoleModel role) {
        try {
    ...
    public JsonResponse getAll() {
        try {
            List<RoleModel> roles = service.findList();
    ...
    public JSONObject queryOfEasyui(@RequestParam(value = "name", required = false) String name, @RequestParam(value = "description", required = false) String description) {
        ...
        try {
            List<RoleModel> listAll = service.getListByNameAndDescription(name, description);

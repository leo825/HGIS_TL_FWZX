...
//    @ResponseBody
//    public JsonResponse save(@RequestBody Usage model) {
//        try {
...
//    @ResponseBody
//    public JsonResponse update(@RequestBody Usage usage) throws Exception {
//        try {
...
//        try {
//            List<Usage> usages = service.findList();
...
//        int total = 0;
//        try {
//            List<Usage> usages = service.getListByParms(ip, name);
...
//
//        try {
//            List<Usage> usageList = usageProjectService.getUsageListByParams(ip, name, projectId);
...
//                Usage usage = service.get(usageId);
//                Project project = projectService.get(newProjectId);
//                int result = -1;
//                result = usageProjectService.insert(usage, project);
//                if (result > 0) {

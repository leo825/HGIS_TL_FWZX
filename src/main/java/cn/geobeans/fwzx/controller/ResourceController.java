...
public class ResourceController {
	...
	@ResponseBody
	public JsonResponse save(@RequestBody ResourceModel mode) {
		try {
	...
	@ResponseBody
	public JsonResponse update(@RequestBody ResourceModel resource) {
		try {
	...
	public JsonResponse getAll() {
		try {
			List<ResourceModel> resources = service.findList();
	...
	public JSONObject[] queryOfEasyui(@RequestParam(value = "id", required = false) String id) {
		...
		try {
			List<ResourceModel> resources = service.findList();
			List<ResourceModel> roleResources = roleService.getResourceByRoleId(id);

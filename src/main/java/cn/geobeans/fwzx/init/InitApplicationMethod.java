...
//
//
//    public void buildRoute(final Project project) {
//        try {
...
//     * 动态增加一个servlet路由
//     */
//    public int addServletRoute(final Route routeModel) {
//        int result = -1;
//        try {
//            final Project tempProject = projectService.get(routeModel.getProjectId());
//            RouteBuilder route = new RouteBuilder() {
...
//     */
//    public int deleteServletRoute(Route routeModel) {
//        int result = -1;
//        Project project = projectService.get(routeModel.getProjectId());
//        try {
//            String endPoint = "Endpoint[servlet:///" + project.getName() + "/" + routeModel.getServerName() + "]";
//            List<org.apache.camel.Route> routeList = camelContext.getRoutes();
//            for (org.apache.camel.Route route : routeList) {
...
//     * 更新一个路由设置
//     */
//    public int updateServletRoute(Route oldRoute, Route newRoute) {
//        int result = -1;
//        try {
...
//        try {
//            List<Route> routesList = routeService.findList();
//            if (!StringUtil.isListEmpty(routesList)) {
//                for (Route tempRoute : routesList) {
...
//        }
//
//        public ProcessBegin(Route route, Project project) {
//            this.route = route;
...
//                Usage u = usageService.getByIp(ip);
//
...
//        Operation operation = new Operation(ip, serverName, projectName, result, userName, description);
...
//     */
//    public void addFailLogToReport(Operation operation) {
//        String filePath = "";

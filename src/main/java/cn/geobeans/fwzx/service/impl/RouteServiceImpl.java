...
//
//    public int insert(final Route model) {
...
//        Route model = null;
//        try {
//            model = jdbcTemplate.queryForObject(sql, new Object[]{id}, new BeanPropertyRowMapper<Route>(Route.class));
//        } catch (Exception e) {
//            return null;
//        }
//        return model;
...
//        try {
//            list = (List<Route>) jdbcTemplate.query(sql, new BeanPropertyRowMapper<Route>(Route.class));
//        } catch (Exception e) {
//            return null;
//        }
//        return list;
...
//        Route model = null;
//        try {
//            model = jdbcTemplate.queryForObject(sql, new Object[]{serverName}, new BeanPropertyRowMapper<Route>(Route.class));
//        } catch (Exception e) {
//            return null;
//        }
//        return model;
//    }
//
//    public int update(final Route model) {

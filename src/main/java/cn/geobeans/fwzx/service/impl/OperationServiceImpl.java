...
//
//    @Override
//    public int insert(final Operation model) {
...
//        try {
//            model = jdbcTemplate.queryForObject(sql, new Object[]{id}, new BeanPropertyRowMapper<Operation>(Operation.class));
//        } catch (Exception e) {
//            return null;
//        }
//        return model;
...
//        try {
//            list = (List<Operation>) jdbcTemplate.query(sql, new BeanPropertyRowMapper<Operation>(Operation.class));
//        } catch (Exception e) {
//            return null;
//        }
//        return list;
